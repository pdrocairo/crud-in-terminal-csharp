...
namespace crud_in_terminal_csharp.templates {
    internal class UI {
        ...
        public static void MenuLogin() {
            ...
            string senha = Console.ReadLine();
            View.AutenticarLogin(email, senha);
        }
        ...
        public static string MenuPrincipalCliente() {
            ...
            Console.WriteLine("3. Visualizar o Carrinho");
        ...
        public static List<string> ObterDadosCliente() {
            ...
            objetos.AddRange(nome, email, telefone, senha);
            return objetos;
        }
        ...
        public static List<string> ObterDadosProduto() {
            ...
            objetos.AddRange(descricao, preco, estoque, idCategoria);
            return objetos;
        }
    }
}
